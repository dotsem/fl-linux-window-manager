...
struct _FlLinuxWindowManagerPlugin {
  GObject parent_instance;
};

G_DEFINE_TYPE(FlLinuxWindowManagerPlugin, fl_linux_window_manager_plugin, g_object_get_type())
...
static void fl_linux_window_manager_plugin_dispose(GObject* object) {
  G_OBJECT_CLASS(fl_linux_window_manager_plugin_parent_class)->dispose(object);
}

static void fl_linux_window_manager_plugin_class_init(FlLinuxWindowManagerPluginClass* klass) {
  G_OBJECT_CLASS(klass)->dispose = fl_linux_window_manager_plugin_dispose;
}
